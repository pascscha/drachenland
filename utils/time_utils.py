...
def is_store_open(schedule: Dict[str, Any], current_dt: datetime.datetime = None) -> bool:
    """
...
def get_default_schedule() -> Dict[str, List[Dict[str, str]]]:
    ...
    return {
        ...
        "Thu": [{"start": "09:00", "end": "12:00"}, {"start": "13:30", "end": "17:00"}], # Note: User said 17:-- assuming 17:00 based on context
